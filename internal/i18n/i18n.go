...
var ko = map[string]string{
	...
	"auth.captcha.remote.prompt":    "아래 보안 릴레이를 열어 봇 호스트에서 실행 중인 Chrome의 Riot 캡차를 완료하세요. 렌더링된 캡차 화면과 포인터 입력만 중계됩니다. 이 링크는 곧 만료됩니다.",
...
var en = map[string]string{
	...
	"auth.captcha.remote.prompt":    "Open the secure relay below to complete Riot's captcha in Chrome running on the bot host. Only rendered captcha frames and pointer input are relayed. This link expires shortly.",
