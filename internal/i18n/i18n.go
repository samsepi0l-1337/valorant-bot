...
var ko = map[string]string{
	...
	"auth.captcha.prompt":           "아래 버튼을 누르면 봇이 실행 중인 이 Mac/PC에서 Chrome 캡차 창을 엽니다.\n그 창에서 **「로봇이 아닙니다」**만 체크하세요.",
...
var en = map[string]string{
	...
	"auth.captcha.prompt":           "Tap the button below to open a Chrome captcha window on the bot Mac/PC.\nCheck **I'm not a robot** in that window.",
